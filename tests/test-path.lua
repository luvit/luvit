...
assert(path.basename(__filename) == "test-path.lua")
assert(path.basename(__filename, ".lua") == "test-path")
...
assert(path_base.nt:relative('c:/', 'c:\\aaaa\\bbbb') == 'aaaa\\bbbb', path_base.nt:relative('c:/', 'c:\\aaaa\\bbbb'))
