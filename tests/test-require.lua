...
_G.num_loaded = 0
local m1 = load("module1")
local m1_m2 = load("module1/module2")
local m1_m2 = load("module1/module2")
local m1_m2 = load("module1/module2")
local m2_m2 = load("module2/module2")
local rm1 = load("./modules/module1")
local rm1_m2 = load("./modules/module1/module2")
local rm2_m2 = load("./modules/module2/module2")
local rm1sm1_m2 = load("./modules/module1/../module1/module2")
local rm2sm2_m2 = load("./modules/module2/../module2/module2")
