...
require('tap')(function(test)
  ...
  test('should parse url http://localhost:9000', function (expected)
	...
	local expected = {href = 'http://localhost:9000', protocol = 'http', host = 'localhost:9000', hostname = 'localhost', path = '/', pathname = '/', port = '9000'}
	assert(deepEqual(expected, parsed))	
  end)
  ...
  test('should parse url https://GabrielNicolasAvellaneda:s3cr3t@github.com:443/GabrielNicolasAvellaneda/luvit', function (expected)
	...
	local expected = {href = 'https://GabrielNicolasAvellaneda:s3cr3t@github.com:443/GabrielNicolasAvellaneda/luvit', protocol = 'https', auth = 'GabrielNicolasAvellaneda:s3cr3t', host = 'github.com:443', hostname = 'github.com', port = '443', path = '/GabrielNicolasAvellaneda/luvit', pathname = '/GabrielNicolasAvellaneda/luvit'}
	assert(deepEqual(expected, parsed))
  end)
